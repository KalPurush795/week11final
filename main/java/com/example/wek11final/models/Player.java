...
/**
 * Represents a Player model that extends the common SoccerEntity interface[cite: 28].
 * The properties match the fields provided in the example players data[cite: 77].
 */
